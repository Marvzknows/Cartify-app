        ...
        <PageLayout>
            <div className="flex justify-end gap-2 items-center">
                ...
                <div className="relative">
                    <img onClick={handleProfileDropdown} className="rounded-2xl cursor-pointer" src={profileIcon} width={30} />
                    {
                        showProfileDropdown && <div className="absolute top-[35px] right-0 md:left-0">
                        <AccountDropdown />
                    </div>
                    }
                    
                </div>
                <small className="hidden md:block">Username</small>
                ...
                <button className="relative p-3.5 overflow-hidden">
                    ...
                    <TbShoppingCartPlus className="text-lg transition-transform duration-300 hover:scale-110" />
                </button>
            </div>
